...
@BindingAdapter("writtenReviewProfile")
fun writtenReviewProfile(imageView: ImageView, uri: String) {
    if(uri != "") {
...
@BindingAdapter("reviewNullVisibility")
fun reviewNullVisibility(textView: TextView, list: MutableList<WrittenReviewResult>?) {
    if(list != null) {
        if(list.size == 0)
